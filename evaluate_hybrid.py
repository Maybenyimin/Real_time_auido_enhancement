...
from models.hybrid_model import HybridModel  # ✅ Use HybridModel
...
def load_model(config):
    model = HybridModel(config)  # ✅ Instantiate HybridModel
    model.load_state_dict(torch.load("checkpoints/hybrid_epoch056.pt", map_location=DEVICE))
...
def evaluate(config_path):
    ...
    output_dir = "enhanced_outputs/hybrid"  # ✅ Separate folder for hybrid results
...
if __name__ == "__main__":
    evaluate("config.yaml")  # ✅ Use hybrid config
